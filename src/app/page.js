...
const App = () => {
        ...
        <div className="p-4">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-4 md:gap-6 relative">
            ...
            <div className="w-full lg:w-64 bg-gray-50 shadow-md  p-4 space-y-4 py-10 md:py-20 lg:absolute lg:right-[-15]  lg:top-0 h-auto md:h-[620px] rounded animate-fadeInUp lg:mt-[-147px]">
              ...
              {/* Login Button */}
              <button
                className="w-full bg-[#290c52] text-white py-2 cursor-pointer rounded transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
  ...
  <p className="text-2xl md:text-5xl pt-3 md:pt-5 font-semibold text-center">
    Welcome to our website<br/><span className="text-[#290c52] text-4xl">MPCPCT.COM</span>
  </p>
  <div className="">
  <p className="text-base md:text-xl mt-3 md:mt-6 text-center">
    ...
    Learn fast and accurate typing is need for many kind of government jobs.
  </p>
  <p className="text-sm md:text-lg mt-2 md:mt-4 pl-2">
    <span className="font-semibold">Tip:</span> For taking a typing test in mobile phone connect your mobile to keyboard with an OTG cable.
  </p>
  </div>
</div>
      </div>
