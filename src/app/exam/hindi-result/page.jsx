...
export default function HindiResult() {
    ...
    <div className="min-h-screen bg-white text-sm">
      ...
      <div className="p-4">
        ...
        <p className="font-semibold mb-2 text-gray-800">
          हिंदी टाइपिंग  : <span className="text-gray-600">( Current Section )</span>
        </p>
          ...
          <table className="w-full text-center border border-gray-300">
            ...
            <tbody>
              <tr className="text-sm">
                <td className="border-r p-2">हिंदी टाइपिंग टेस्ट</td>
                <td className="border-r p-2">0</td>
                <td className="border-r p-2">0</td>
                <td className="border-r p-2">0</td>
                <td className="p-2">14 : 51</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="px-4">
        ...
        <p className="text-sm mt-4 font-semibold text-gray-700">
          English Typing : <span className="text-gray-500">( Yet to attempt )</span>
        </p>
      </div>
