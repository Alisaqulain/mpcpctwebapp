      ...
      <div className="overflow-x-auto">
        <table className="w-full border border-gray-400 text-center font-semibold text-xs sm:text-sm">
          ...
          <tbody>
            ...
            <tr>
              <td className="border p-1 text-center">78</td>
              <td className="border p-1">30</td>
              <td className="border p-1">52 WPM </td>
              <td className="border p-1">27 WPM</td>
            </tr>
            <tr>
              <td className="border p-1 text-center" colSpan={2}>78.88%</td>
              <td className="border p-1">52% </td>
              <td className="border p-1">27%</td>
            </tr>
            <tr>
              <td className="border p-1 text-center" colSpan={2}>Qualified</td>
              <td className="border p-1">Qualified </td>
              <td className="border p-1">Not Qualified</td>
            </tr>
            <tr className="font-bold">
              <td className="border p-1 text-center">Total</td>
              <td colSpan="3" className="border p-1 text-center">69/100</td>
            </tr>
            <tr className="font-bold">
              <td className="border p-1 text-center">Final Result</td>
              <td colSpan="3" className="border p-1 text-left pl-1 sm:pl-4">
                <span className="text-green-600">Pass  </span> 
                <span className="pl-1 sm:pl-3">(Qualified only computer Proficiency & English Typing)</span>
              </td>
            </tr>
          </tbody>
        </table>
          ...
          <table className="w-full border-collapse font-semibold">
            <tbody>
              ...
              <tr className="">
                ...
                <td className="border p-1">Computer Proficiency </td>
                <td className="border p-1">38 out of 75</td>
              </tr>
              <tr>
                <td className="p-1 text-left text-xs sm:text-[15px] pl-1 sm:pl-2" colSpan={2}>Website MPCPCT.Com</td>
                <td className="border p-1">English Typing  </td>
                <td className="border p-1">Minimum Passing Net Speed 30 Word per Minute</td>
              </tr>
              <tr>
                ...
                <td className="border p-1">Hindi Typing  </td>
                <td className="border p-1">Minimum Passing Net Speed 20 Word per Minute</td>
              </tr>
            </tbody>
          </table>
        </div>
